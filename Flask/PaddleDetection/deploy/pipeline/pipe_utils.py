...
class PushStream(object):
    def __init__(self, pushurl="rtsp://127.0.0.1:8554/"):
        self.command = ""
        # self.command = "ffmpeg -re -i adl-13-cam0.mp4 -c:v libx264 -preset veryfast -b:v 3000k -maxrate 3000k -bufsize 6000k -pix_fmt yuv420p -g 50 -c:a aac -b:a 128k -f  rtsp rtsp://192.168.137.1:8554/test"
        # 自行设置
